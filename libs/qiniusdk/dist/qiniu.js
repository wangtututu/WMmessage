    ...
    function QiniuJsSDK() {
        ...
        this.uploader = function (op) {
            ...
            var getUpHosts = function (uptoken) {
                ...
                var uphosts_url = window.location.protocol + "//uc.qbox.me/v1/query?ak=" + "juvLQ2_Spd_j8VXjZqXbzp5wwU5sbN1-ZJm5_BMk" + "&bucket=lipo1990";
            ...
            var getNewUpToken = function (file) {
                if (op.uptoken) {
                    ...
                    if (ajax.status === 200) {
                        // var res = that.parseJSON(ajax.responseText);
                        // that.token = "juvLQ2_Spd_j8VXjZqXbzp5wwU5sbN1-ZJm5_BMk" + ajax.responseText;
                        ...
                        var serverTime = getTimestamp(new Date());
